    ...
    For($threshold_toSell1000 = 5.0; $threshold_toSell1000 -le 5.0; $threshold_toSell1000+=0.1){
        ...
        For($investigate_ratio_toSellMore = 0.9; $investigate_ratio_toSellMore -le 1.0; $investigate_ratio_toSellMore+=0.05){
            ...
            For($toSellMoreStock_amount = 1.0; $toSellMoreStock_amount -le 1.0; $toSellMoreStock_amount+=0.05){
                ...
                python ./stockAnalyzer_4mode_K_50vs50.py $threshold_toBuy500 $threshold_toSell1000 $investigate_ratio_toSellMore $toSellMoreStock_amount "absBuy_relativeSell" >> result.txt
